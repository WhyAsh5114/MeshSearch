...
const features = [
  ...
  {
    icon: Wallet,
    title: "BitGo Stealth Disbursements",
    description:
      "Relay payments are split through fresh BitGo wallet addresses per search for unlinkable settlements.",
  },
  {
    icon: FileLock2,
...
const stack = [
  ...
  "BitGo MPC wallet infrastructure",
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-12 md:py-16">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-between gap-4 rounded-lg border border-border bg-card p-4">
          ...
          <Button size="lg" className="min-w-35 justify-center" asChild>
